...
target_dir = 'G:\\workingfolder\\here'  # F:\===================PIC TO CHECK\100NCD90

# create 3 sorts of folders  1, duplicated, 2, photo with exif, and 3 photo without exif
duplicated_trash_dir = target_dir + '\\DULIPCATED_PICS_TRASH_BIN'
photo_with_exif = target_dir + '\\PHOTO_WITH_EXIF'
